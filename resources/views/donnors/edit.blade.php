@extends('layouts.app' , ['title' => 'Edit Donnor Detail'])

@section('content')
    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        <div class="kt-portlet kt-portlet--mobile">
            <form class="form" id="add_new_donnor_form" method="POST" action="{{ route('panel.updateDonnor' , $data['donnor']->donnor_id) }}" enctype="multipart/form-data">
                <div class="card-body">
                    <div class="row mb-2">
                        <div class="col-lg-8">
                            <div class="row">
                                <div class="col-lg-6 mb-2">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="donnor_name" id="donnor_name" value="{{ $data['donnor']->donnor_name ?? '' }}" class="form-control" placeholder="Enter Donor Name" autocomplete="false"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6 mb-2">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <input type="email" name="donnor_email" id="donnor_email" value="{{ $data['donnor']->donnor_email ?? '' }}" class="form-control" placeholder="Enter Donor Email" autocomplete="false"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6 mb-2">
                ...
                <div class="card-footer">
                    <div class="row text-right">
                        ...
                        <div class="col-lg-8">
                            <button type="submit" class="btn btn-primary mr-2">Update Donor</button>
                        </div>
                    </div>
                </div>
            </form>
